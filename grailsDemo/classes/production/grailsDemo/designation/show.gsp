...
<html>
    ...
    <body>
        ...
        <div id="show-designation" class="content scaffold-show" role="main">
            ...
            <f:display bean="designation" />
            <g:form resource="${this.designation}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.designation}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
