...
class AuthorControllerSpec extends Specification {
    ...
    def populateValidParams(params) {
        ...
        //Author authorMock = Mock(Author)

        params["firstName"] = 'A'
        params["middleInitial"] = 'B'
        params["lastName"] = 'C'
        params["dateOfBirth"] = new Date()
        params["gender"] = 'male'
        /*params["address.address1"] = 'D'
        params["address.address2"] = 'E'
        params["address.city"] = 'F'
        params["address.state"] = 'G'
        params["book.title"] = 'H'
        params["book.isbn"] = 'I'
        params["book.published"] = new Date()*/
    }
